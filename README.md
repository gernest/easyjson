...
```sh
# install
go get -u github.com/gernest/easyjson/...
...
listing](https://godoc.org/github.com/gernest/easyjson) for the full listing of
...
Please see the [GoDoc listing](https://godoc.org/github.com/gernest/easyjson/buffer)
